 ...
 */
var SHEET_HEADERS_ = {
  'イベント': ['イベントID', '日付', '名称', 'ステータス', 'フォームURL', 'フォームID', 'コード', '幹事パスワード', 'MVP確定', 'LINEグループID'],
  'メンバー': ['メンバーID', 'イベントID', '名前', '年次', 'サッカー経験', '幹事', '備考', '意気込み'],
  'ラウンド': ['ラウンドID', 'イベントID', 'ラウンド番号', 'チーム分けJSON', 'ステータス'],
  'マッチ': ['マッチID', 'ラウンドID', 'マッチ番号', 'チームA名', 'チームB名', 'ステータス'],
  'マッチメンバー': ['マッチID', 'メンバーID', 'チーム', '助っ人'],
  '得点': ['得点ID', 'マッチID', 'チーム', 'メンバーID', '種別'],
  'アンケート回答': ['イベントID', '回答者名', '対象メンバーID', '対象メンバー名', 'コメント'],
  'MVP結果': ['イベントID', 'メンバーID', '名前', '順位', '称号', '理由', 'レーティング', '評価コメント']
};
